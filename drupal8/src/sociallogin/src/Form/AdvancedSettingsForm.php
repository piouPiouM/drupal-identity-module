...
class AdvancedSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['lr_interface_settings']['interface_size'] = [
      ...
      '#default_value' => $config->get('interface_size'),
      '#options' => [
        0 => t('Small'),
        1 => t('Large'),
      ],
    ...
    $form['lr_interface_display_settings']['register_form'] = [
      ...
      '#default_value' => $config->get('register_form'),
    ];
    $form['lr_interface_display_settings']['commenting_form'] = [
      ...
      '#default_value' => $config->get('commenting_form'),
    ];
    $form['lr_interface_display_settings']['widget_location'] = [
      ...
      '#default_value' => $config->get('widget_location'),
    ];
    ...
    $form['lr_user_settings']['admin_login'] = [
      ...
      '#default_value' => $config->get('admin_login'),
    ];
    ...
    $form['lr_user_settings']['popup_title'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Please enter the title of the pop-up asking users to enter their email address'),
    ...
    $form['lr_user_settings']['welcome_email'] = [
      ...
      '#default_value' => $config->get('welcome_email'),
    ];
    ...
    $form['lr_user_settings']['update_user_profile'] = [
      ...
      '#default_value' => $config->get('update_user_profile'),
    ];
    $form['lr_user_settings']['skip_email_verification'] = [
      ...
      '#default_value' => $config->get('skip_email_verification'),
    ];
