...
class RaasUserManager {
  ...
  function raas_update_user_table($raas_uid, $user_id) {
  try {
 ...
 * @return mixed
 */
function raas_get_raas_uid($user_id) {
 ...
 * @return mixed
 */
function raas_unblock_user($uid) {  
   $accountObj = new AccountAPI($this->apiKey, $this->apiSecret, array('output_format' => 'json'));
    try {
...
function raas_get_raas_user_id($account_id) {
...
function raas_create_user($data){
  try {
  $userObj = new UserAPI($this->apiKey, $this->apiSecret);
...
function raas_set_password($uid, $password){
    try {
...
function raas_unlink_account($raas_uid, $provider, $provider_id){ 
    try {
  $accountObj = new AccountAPI($this->apiKey, $this->apiSecret,  array('output_format' => 'json'));
