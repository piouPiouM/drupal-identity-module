 ...
 function showAndHideUI() { 
      var options = jQuery('input[name=lr_raas_email_verification_condition]:checked').val();   
          if (options == 2) {                
                  ...
                  jQuery('.form-item-lr-raas-enable-user-name').hide();   
                  jQuery('.form-item-lr-raas-ask-email-always-for-unverified').hide();   
              } else if(options == 1) {                  
                   jQuery('.form-item-lr-raas-enable-login-on-email-verification').show();
                   jQuery('.form-item-lr-raas-prompt-password-on-social-login').hide(); 
                   jQuery('.form-item-lr-raas-enable-user-name').hide();
                   jQuery('.form-item-lr-raas-ask-email-always-for-unverified').show();                   
              } else {                  
                   jQuery('.form-item-lr-raas-enable-login-on-email-verification').show();                
                   jQuery('.form-item-lr-raas-prompt-password-on-social-login').show();                
                   jQuery('.form-item-lr-raas-ask-email-always-for-unverified').show();  
                   jQuery('.form-item-lr-raas-enable-user-name').show();
              }       
}
